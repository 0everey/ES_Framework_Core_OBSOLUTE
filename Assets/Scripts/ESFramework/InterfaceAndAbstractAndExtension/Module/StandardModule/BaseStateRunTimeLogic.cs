...
namespace ES
{
    public interface IState:IDelegatedUpdatable
    {
    ...
    public abstract class BaseStateMachine : RightlyCompleteDelegatableAndUpdatableAndHostingWithHosting<IPrimaryHosting>,IStateMachine,IState
    {
        ...
        [LabelText("自己的运行中状态")]
        public ListSafeUpdate<IState> SelfRunningStates= new ListSafeUpdate<IState>();
    ...
    public abstract class BaseWithableStateRunTimeLogic<Machine, Key, SharedData, Status, This> : BaseStateRunTimeLogic<Machine, Key, SharedData, Status, This>
       where This : BaseStateRunTimeLogic<Machine, Key, SharedData, Status, This>
        ...
        where Status : IStateStatus
    {
        [FoldoutGroup("默认委托")] public Action<This> Action_OnPrepared;
        [FoldoutGroup("默认委托")] public Action<This> Action_OnEnter;
        [FoldoutGroup("默认委托")] public Action<This> Action_OnExit;
        [FoldoutGroup("默认委托")] public Action<This> Action_Update;
        [FoldoutGroup("默认委托")] public Action<This> Action_OnStateUpdate;
    ...
    public abstract class BaseStateMachine<Key,Logic> : BaseStateMachine where Logic:Delegatable, IState
    {
        ...
        public override IEnumerable<IDelegatedUpdatable> normalBeHosted => states.Values;
        ...
        public void RegesterNewState(Key key, IState logic)
        {
            ...
            else
            {
                ...
                if(logic is ISubHosting logic1)
                {
                    logic1.TrySubmitHosting(this);
        ...
        public override bool OnSubmitHosting(IPrimaryHosting hosting, bool asVirtual = false)
        {
            host = hosting;
            return true;
        }
    ...
    public class BaseStandardStateMachine : BaseMicroStateMachine_StringKey
    {
